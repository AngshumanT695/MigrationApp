...
import { cmdOutputFormat, dryRunResultFormat } from '../../interfaces/interfaces';
import { updateProblems } from '../../interfaces/enumerations';

export function parseForError(dryRunOutput: cmdOutputFormat): dryRunResultFormat
{
...
export function parseForNoError(dryRunOutput: cmdOutputFormat): dryRunResultFormat
{
    const outputLines: Array<string> = breakOutputInLines(dryRunOutput.stdout);
